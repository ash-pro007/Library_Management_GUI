...
class AppTk:
    ...
    def submit_book(self):
        ...
        def add_submit_record():
            ...
            if is_record_in_db:
                cur.execute(F'UPDATE book_record SET returned_at="{return_date}" where id="{student_id}"')
                db.commit()
    ...
    def track_student(self):
        ...
        def track(coming_from):
            ...
            if all_ok:
                ...
                treeview_history.tag_configure('green', background='Light Green')
                treeview_history.tag_configure('yellow', background='Light Yellow')
                treeview_history.tag_configure('red', background='Light Red')
                ...
                for tpl2 in list_record:
                    ...
                    if tpl2[3] is not None and tpl2[3] != '':
                        for n in tpl2[3]:
                            try:
                                retured_date_sum += int(n)
                            except:
                                continue

                    print(issued_to_date_sum)
                    print(retured_date_sum)

                    if  tpl2[3] == None or tpl[3] == '':
                    ...
                    elif issued_to_date_sum >= retured_date_sum:
                        treeview_history.insert(parent='', index='end',
                                                image=self.lst_all_book_images[count2 - 1],
                                                values=(
                                                    tpl2[0], tpl2[1], tpl2[2], tpl2[3]
