...
class AppTk:
    ...
    def main_options(self):
        ...
        Label(frame_manage_books_, text='EXTRAAAAAAAAAAAAAAA', relief=FLAT, background=self.settings['btn_primary_bg_color'],
               font=self.settings['primary_font'],
    ...
    def add_book(self):
        ...
        # Frame_adding_date is frame in which all date related component are packed()
        frame_adding_date = LabelFrame(self.frame_add_book)
